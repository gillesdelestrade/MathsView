...
MathsExos.catalogue = [
  ...
  { code: 'eq-quotient-nul', libelle: 'Équations quotient nul',  niveau: '2nde',
    chapitre: 'algebre', prerequis: ['eq-produit-nul'] },
  ...
  { code: 'ineq-quotient', libelle: 'Inéquations quotient',     niveau: '2nde',
    chapitre: 'algebre', prerequis: ['ineq-produit'] },
  ...
  { code: 'proportions',    libelle: 'Proportions et pourcentages', niveau: '5eme',
    chapitre: 'calcul-5e', prerequis: ['fractions'] },
  { code: 'proportionnalite-graphique',
    libelle: 'Proportionnalité : tableau et graphique', niveau: '5eme',
    chapitre: 'calcul-5e', prerequis: ['proportions'] },
  { code: 'probabilites-vocabulaire',
    libelle: 'Le vocabulaire des probabilités', niveau: '5eme',
    chapitre: 'donnees-5e', prerequis: [] },
  { code: 'probabilites-equiprobabilite',
    libelle: 'Attribuer des probabilités', niveau: '5eme',
    chapitre: 'donnees-5e', prerequis: ['probabilites-vocabulaire'] },
