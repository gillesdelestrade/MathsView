...
| `flash-fondamentaux` | Le barème est vérifié aux bornes exactes (2999 / 3000 / 5999 / 6000 ms). Les 145 faits déclarés doivent être du rappel pur et arithmétiquement justes, sans clé en double, et rester dans les bornes que le nom de la compétence promet. Le tirage est sans remise et pondéré : les faits ratés doivent ressortir au moins trois fois plus souvent que le hasard, et l'ordre des poids (jamais vu > faux > lent > moyen > su) est exigé strictement. Les pièces : une tous les 12 points, 5 au plus, et **seulement la première séance du jour** — la même journée, une séance parfaite ne rapporte rien ; le lendemain, 60 points valent 5 pièces et 59 en valent 4. Enfin le cloisonnement : une empreinte de la maîtrise, des ceintures et de l'XP est prise avant une séance entière, et doit être identique après. |
