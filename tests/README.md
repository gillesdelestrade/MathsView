...
| `lecon-proportions` | Le pourcentage, la fraction simplifiée et le complément sont recalculés indépendamment, pour les quatre situations et toutes les valeurs de la partie. Les deux grilles doivent dire la même chose que le calcul : autant de carreaux que le tout, exactement cent pour la seconde. |
