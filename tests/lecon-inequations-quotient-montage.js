/*
 * La leçon « Inéquations quotient » (2nde), montée avec le VRAI JSXGraph.
 *
...
load('lessons/2nde/inequations-quotient.js');
...
var pts = board.objectsList.filter(function (o) { return o.elType === 'point' && o.getAttribute('size') === 6; });
